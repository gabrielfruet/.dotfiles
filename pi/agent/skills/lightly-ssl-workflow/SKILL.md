...
- Map touchpoints before editing: public exports (`__init__.py`), docs autodoc page, example page/script if user-facing, the parent toctree that exposes it, and minimal tests.
